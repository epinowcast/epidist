...
- [`epidist_formula_model(`*`<epidist_naive_model>`*`)`](https://epidist.epinowcast.org/dev/reference/epidist_formula_model.epidist_naive_model.md)
  :
...
- [`add_mean_sd(`*`<lognormal_samples>`*`)`](https://epidist.epinowcast.org/dev/reference/add_mean_sd.lognormal_samples.md)
  ...
  lognormal model
- [`add_mean_sd(`*`<weibull_samples>`*`)`](https://epidist.epinowcast.org/dev/reference/add_mean_sd.weibull_samples.md)
  : Add natural scale mean and standard deviation parameters for a
  Weibull model
- [`predict_delay_parameters()`](https://epidist.epinowcast.org/dev/reference/predict_delay_parameters.md)
  [`predict_dpar()`](https://epidist.epinowcast.org/dev/reference/predict_delay_parameters.md)
...
- [`assert_epidist()`](https://epidist.epinowcast.org/dev/reference/assert_epidist.md)
...
- [`epidist_family_model()`](https://epidist.epinowcast.org/dev/reference/epidist_family_model.md)
  [`epidist_formula_model()`](https://epidist.epinowcast.org/dev/reference/epidist_family_model.md)
  :
...
- [`epidist_formula_model(`*`<default>`*`)`](https://epidist.epinowcast.org/dev/reference/epidist_formula_model.default.md)
...
- [`epidist_model_prior(`*`<default>`*`)`](https://epidist.epinowcast.org/dev/reference/epidist_model_prior.default.md)
...
- [`epidist_stancode(`*`<default>`*`)`](https://epidist.epinowcast.org/dev/reference/epidist_stancode.default.md)
...
- [`epidist_gen_log_lik()`](https://epidist.epinowcast.org/dev/reference/epidist_gen_log_lik.md)
  : Create a function to calculate the marginalised log likelihood for
  double censored and truncated delay distributions
- [`epidist_gen_posterior_epred()`](https://epidist.epinowcast.org/dev/reference/epidist_gen_posterior_epred.md)
...
- [`reexports`](https://epidist.epinowcast.org/dev/reference/reexports.md)
  [`lognormal`](https://epidist.epinowcast.org/dev/reference/reexports.md)
  [`weibull`](https://epidist.epinowcast.org/dev/reference/reexports.md)
  [`Gamma`](https://epidist.epinowcast.org/dev/reference/reexports.md)
  [`bf`](https://epidist.epinowcast.org/dev/reference/reexports.md) :
