...
2.  Summarising the data by counting unique combinations of these
    ...
    [`.summarise_n_by_formula()`](https://epidist.epinowcast.org/dev/reference/dot-summarise_n_by_formula.md)
...
4.  Informing the user about any data aggregation that occurred using
    [`.inform_data_summarised()`](https://epidist.epinowcast.org/dev/reference/dot-inform_data_summarised.md)
