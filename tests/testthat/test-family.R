# fmt: skip file
test_that(
  "epidist_family with default settings produces an object of the right class", { # nolint: line_length_linter.
...
test_that(
  "epidist_family gives an error when passed inappropriate family input", { # nolint: line_length_linter.
