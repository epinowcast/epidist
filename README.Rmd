...
> [!CAUTION]
> This package is a prototype and is under active development. Breaking changes are likely.
...
To learn more about `epidist` we recommend looking at the following vignettes:
...
If you use `epidist` in your work, please consider citing it with `citation("epidist")`:
