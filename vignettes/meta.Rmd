...
![(ref:outbreak)](figures/meta-outbreak-1.png)
...
![(ref:bias)](figures/meta-bias-1.png)
...
Every study measures its delays as its procedure would, rather than being labelled after the fact, so recovering the simulation settings from them is a genuine test of the model.
...
![(ref:compare)](figures/meta-compare-1.png)
...
Fitting this model here, including the one-off cost of compiling the Stan program, took 149 seconds.
...
![(ref:forest)](figures/meta-forest-1.png)
...
![(ref:ebola)](figures/meta-ebola-1.png)
