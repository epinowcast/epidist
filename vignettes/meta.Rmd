...
``` r
round(summary(fit_meta_summary_study)$random$study, 2)
#>                     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> sd(Intercept)           0.15      0.06     0.06     0.30    1   352.69   591.25
#> sd(sigma_Intercept)     0.26      0.08     0.13     0.45    1   444.65   580.98
```
