...
In Figure \@ref(epred) we show the posterior expectation of the delay distribution for each of the three fitted models.
Figure \@ref(pred)B illustrates the higher mean of men as compared with women.
...
```{r linpred-sex-district, fig.cap="(ref:epred)", fig.height = 8}
...
Omitting all delays greater than 30, then (Figure \@ref(fig:pmf)):
