...
One can also generate draws of the linear predictors for all distributional parameters using `add_linpred_draws`.
For example, for the `mu` parameter then:
...
### No truncation with daily censoring
...
### Continuous with no truncation or censoring
