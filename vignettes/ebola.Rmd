...
1. Fitting lognormal and gamma delay distributions, and selecting between fitted models.
...
For users new to `epidist`, we recommend beginning with the [getting started vignette](http://epidist.epinowcast.org/articles/epidist.html) before reading this article.
