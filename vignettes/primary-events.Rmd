...
<div class="figure">
<img src="figures/primary-events-location-estimates-1.png" alt="plot of chunk location-estimates"  />
<p class="caption">(\#fig:location-estimates)plot of chunk location-estimates</p>
</div>
...
Refitting these data with a delay per location widens the interval on every rate by about a fifth.
