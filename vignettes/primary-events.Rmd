...
The delays carry little information about the growth rate, so in practice the prior does the work.
Epidemic growth is usually estimated separately, from case counts over the same period, and that estimate is passed here as a prior.
The prior below is centred on the rate used to simulate, with a scale reflecting how well it is typically known.
...
Take the rate from a separate estimate of epidemic growth and pass it as an informed prior.
