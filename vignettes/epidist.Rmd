...
We see that we have recovered neither of these parameters well and that means that the resulting distribution we have estimated will not reflect the data well.
