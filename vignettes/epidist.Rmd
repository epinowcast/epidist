...
::: {.alert .alert-primary}
`epidist` implements models following best practices in the field of infectious disease epidemiology.
We highly recommend reading @charniga2024best before starting this vignette.
For those interested in the technical details, check out @park2024estimating.
