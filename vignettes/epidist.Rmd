...
Our own observation period ends after `r obs_time` days, so we truncate at the observation date.
...
This sample size corresponds to `r 100 * round(sample_size / nrow(linelist_trunc), 3)`% of the data.
