...
Another approach to this would be providing `newdata` to `predict_delay_parameters()` representing the data we want to make predictions for.
`epidist_newdata()` builds that `newdata` for us.
:::
