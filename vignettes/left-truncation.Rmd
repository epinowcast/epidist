...
<div class="figure">
<img src="figures/left-truncation-pdf-plot-1.png" alt="Predicted delay distributions against the true lognormal density (black line)."  />
<p class="caption">(\#fig:pdf-plot)Predicted delay distributions against the true lognormal density (black line).</p>
</div>
