...
The delays carry little information about $r$, so it is normally supplied as an informed prior taken from a separate estimate of epidemic growth rather than learned here.
```r
