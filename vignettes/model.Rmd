...
For this reason, Our current methodology focusses on biases that affect the estimation of the forward distribution.
...
2. Assume that the censoring interval is narrow such that
$$
