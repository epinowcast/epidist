...
The Laplace method approximates a posterior distribution by a Gaussian distribution centred (by default) at the posterior mode.
...
We now extract the posterior distribution for the delay parameters from the fitted model for each inference method.
Thankfully, each algorithm is implemented to sample draws from the posterior distribution, making post-processing straightforward.
...
<div class="figure">
<img src="figures/approx-inference-posterior-1.png" alt="(ref:posterior)"  />
...
<div class="figure">
<img src="figures/approx-inference-delay-pdf-1.png" alt="(ref:delay-pdf)"  />
<p class="caption">(\#fig:delay-pdf)(ref:delay-pdf)</p>
</div>
