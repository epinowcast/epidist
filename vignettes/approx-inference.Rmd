...
knitr::opts_chunk$set(
  ...
  warning = FALSE,
  error = FALSE,
  # Evaluation is off because this vignette uses pathfinder, which needs a
  # brms path fix that is merged upstream but not yet in a CRAN release.
  # The package now resolves brms from CRAN, so that fix is unavailable.
  # Turn this back on once brms releases it, or precompute the vignette.
  eval = FALSE
)
```
