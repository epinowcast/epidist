...
#'
#' @param weight A column name containing counts to use as weights. If NULL,
#'  each row is assigned a count of 1. Internally this is used to define the
#'  'n' column of the returned object.
#'
