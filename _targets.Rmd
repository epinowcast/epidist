...
- 3 distribution assumptions ("short" (1.2, 0.4), "medium" (1.6, 0.6), "long" (2, 0.8))
...
- Alternatively we could stick with the current grid of growth rates approach and explore across it. 
